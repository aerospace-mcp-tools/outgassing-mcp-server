...
<img src="Araldite 2014 Demo.gif" alt="Araldite 2014 Demo" width="600">

## Overview

This MCP server is built with [FastMCP](https://gofastmcp.com) and containerized with Docker. It provides four tools for querying 13,582 aerospace materials from NASA's outgassing database, with intelligent fuzzy search and automatic compliance checking against NASA-STD-6016 standards.
